...
class LeitnerBoxTest {
    ...
    fun test_day_1_with_7_levels() {
        ...
        val leitnerBox = LeitnerBox(7)

        val levels = leitnerBox.getLevelsForDay(1)

        Assert.assertEquals(arrayListOf(2, 1), levels)
    }
    ...
    fun test_day_2_with_7_levels() {
        ...
        Assert.assertEquals(arrayListOf(3, 1), levels)
    }
    ...
    fun test_day_24_with_7_levels() {
        ...
        Assert.assertEquals(arrayListOf(6, 1), levels)
    }
    ...
    fun test_day_29_with_7_levels() {
        ...
        Assert.assertEquals(arrayListOf(4, 2, 1), levels)
    }
    ...
    fun test_day_56_with_7_levels() {
        ...
        Assert.assertEquals(arrayListOf(7, 1), levels)
    }
    ...
    fun test_day_64_with_7_levels() {
        ...
        Assert.assertEquals(arrayListOf(1), levels)
    }
}